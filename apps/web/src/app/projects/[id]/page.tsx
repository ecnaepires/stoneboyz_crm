      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="mb-1 text-sm text-muted-foreground">
            <Link href="/projects" className="hover:underline">Jobs</Link> / {project.title}
          </div>
              ...
              <div className="rounded-md border p-3">
                ...
                <dl className="grid grid-cols-2 gap-3 text-sm">
                  <div>
                    ...
                    <dd>{orders.some((order) => order.totalPaidCents > 0) ? 'Yes' : '-'}</dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Tearout</dt>
                    <dd>-</dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Ready to Template</dt>
                    <dd>{eventByActivity.has('template') ? 'Yes' : '-'}</dd>
                  </div>
                  <div>
                    <dt className="text-muted-foreground">Approved for Install</dt>
                    <dd>{eventByActivity.has('install') ? 'Yes' : '-'}</dd>
                  </div>
                </dl>
              </div>
              <div className="rounded-md border p-3">
